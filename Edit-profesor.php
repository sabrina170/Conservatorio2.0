        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    ...
                    <h1 class="text-center m-0" style="color: #06599e;"><strong>Editar Porfesor</strong> </h1>
                </div>
            ...
            ?><script src="https://cdn.jsdelivr.net/npm/sweetalert2@8"></script>
                <script>
                    Swal.fire(
                        ...
                        window.location.href = "Edit-profesor.php?id=<?php echo $id; ?>&nt=0";
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    ?>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <form action="controlador/acciones.php?accion=ActualizarUsuario2" method="POST" enctype="multipart/form-data">
                                    <div class="form-row">
